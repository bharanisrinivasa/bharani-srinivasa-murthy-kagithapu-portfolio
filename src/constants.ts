export const PORTFOLIO_DATA = {
  name: "Bharani Srinivasa Murthy Kagithapu",
  role: "Aspiring Cloud Engineer | B.Tech in Cloud Computing",
  location: "Rajahmundry, Andhra Pradesh, India",
  contact: {
    phone: "9392828163",
    email: "bharani5442@gmail.com",
    linkedin: "https://www.linkedin.com/in/bharanisrinivasa",
    github: "https://github.com/bharanisrinivasa",
  },
  summary: "I am a Computer Science & Engineering student at Lovely Professional University with a specialized focus on Cloud Computing. My technical journey is driven by a passion for building scalable, automated, and intelligent systems that solve real-world challenges. From developing Python-based automation tools to exploring the complexities of Cloud Infrastructure, I thrive at the intersection of development and operations.With a toolkit that includes Docker, AWS, and Oracle Cloud, I am dedicated to creating seamless bridges between clean code and robust deployment. Whether I am architecting a real-time vehicle parking system or integrating live chatbots into web platforms, my goal is to deliver efficient, high-impact solutions. I am a lifelong learner, constantly evolving my skills to master the modern tech stack and contribute to the future of cloud-native engineering.",
  ...
  projects: [
    {
      ...
      link: "https://github.com/bharanisrinivasa/Automatic-File-Renamer-and-Organizer"
    },
    {
      title: "Online Food Ordering System",
      description: "A comprehensive food ordering platform featuring a live chatbot for customer interaction.",
      tags: ["Web Development", "Chatbot", "NodeJS"],
      image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=800&h=500",
      link: "https://github.com/bharanisrinivasa/Online-food-ordering-and-delivering-system"
    },
    {
      title: "Vehicle Parking Website",
      description: "A real-time tracking system for vehicle parking management.",
      tags: ["Real-time Tracking", "MySQL", "JavaScript"],
      image: "https://images.unsplash.com/photo-1506521781263-d8422e82f27a?auto=format&fit=crop&q=80&w=800&h=500"
    }
  ],
  skills: [
  ...
  education: [
    ...
    {
      institution: "TIRMUALA JUNIOR COLLEGE",
      degree: "Intermediate",
      period: "April 2021 - March 2023"
    },
    {
      institution: "TIRMUALA SCHOOL",
